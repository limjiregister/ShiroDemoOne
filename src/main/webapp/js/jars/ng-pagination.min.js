	...
	e.module("ng-pagination", []).constant("ngPaginationConfig", {
		...
		return {
			link: function (n, a, g) {
				function i() {
					var e, t, a;
					if (n.pagenums = [], 0 !== n.pageCount)for (n.currentPage > n.pageCount &&
					                                            (n.currentPage = 1), n.pageCount <= o ? (e = 1, t
						= n.pageCount) : (a = Math.ceil(o / 2), e = Math.max(n.currentPage - a, 1), t = Math.min(
						e + o - 1, n.pageCount), n.pageCount - t < a && (e = t - o + 1)); t >= e; e++)n.pagenums.push(e)
				}

				var o = e.isDefined(g.visiblePageCount) ? g.visiblePageCount : t.visiblePageCount;
				n.firstText = e.isDefined(g.firstText) ? g.firstText : t.firstText, n.lastText = e.isDefined(
					g.lastText) ? g.lastText : t.lastText, n.prevText = e.isDefined(
					g.prevText) ? g.prevText : t.prevText, n.nextText = e.isDefined(
					g.nextText) ? g.nextText : t.nextText, n.showFirstLastText = e.isDefined(
					g.showFirstLastText) ? g.showFirstLastText : t.showFirstLastText, n.showIfOnePage = e.isDefined(
					g.showIfOnePage) ? g.showIfOnePage : t.showIfOnePage, n.gotoText = e.isDefined(
					g.gotoText) ? g.gotoText : t.gotoText, n.showGoto = e.isDefined(
					g.showGoto) ? g.showGoto : t.showGoto, n.currentPage = 1, n.pageChange = function (e) {
					...
					if (Number.isNaN(a)) {
						...
						e.preventDefault()
					} else a >= 1 && a <= n.pageCount ||
					(1 > a ? e.target.value = 1 : e.target.value = n.pageCount), 13 === e.keyCode && (n.currentPage = a)
